        ...
        <div class="ibox">
            ...
            <div class="ibox-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary mb-2 form-control" data-toggle="modal" data-target="#comment">
                ...
                <!-- Modal -->
                @include('product-order.assingToDeliveryAgentModal')
                @include('product-order.commentModal')
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <b> Status : </b> {{$productOrder->status}}
                        </div>
