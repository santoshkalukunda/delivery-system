...
<body class="container-fluid mt-3">
    ...
    {{-- <div>
        <a href="https://closetnepal.com.np/">
            <img src="{{asset('assets/img/logo.png')}}" class="" width="20%" alt="closet Nepal Logo">
        </a>
    </div> --}}
        ...
        <form action="" method="get">
            <div class="row justify-content-center py-5">
                ...
                <div class="col-md-5 form-group">
                    <input type="text" class="form-control" name="product_order_id" placeholder="Order Number"
                        autofocus>
                </div>
